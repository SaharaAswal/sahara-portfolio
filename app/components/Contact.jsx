    ...
    return (
        <motion.div
            ...
            <motion.h4
                ...
                className='text-center mb-2 text-lg font-Ovo'>Let’s Connect</motion.h4>
            <motion.h2
                initial={{ opacity: 0, y: -20 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.5, duration: 0.5 }}
                className='text-center text-5xl font-Ovo'>Open To Opportunities</motion.h2>
            <motion.p
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                transition={{ delay: 0.7, duration: 0.5 }}
                className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
                Whether it’s a project idea, a collaboration, or a simple greeting — feel free to get in touch using the form below. I'd love to connect!
            </motion.p>
            <motion.form
                initial={{ opacity: 0, }}
                whileInView={{ opacity: 1, }}
                ...
                <motion.button
                    ...
                    Submit now
                    <Image src={assets.right_arrow_white} alt='right-arrow-white' className='w-4' />
                </motion.button>
